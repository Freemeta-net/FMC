...
import (
	...
	"github.com/Freemeta-net/FMC/ethdb/leveldb"
	"github.com/Freemeta-net/FMC/ethdb/memorydb"
...
func InspectDatabase(db ethdb.Database, keyPrefix, keyStart []byte) error {
	...
	for it.Next() {
		...
		case bytes.HasPrefix(key, []byte("taerim-")) && len(key) == 7+common.HashLength:
			taerimSnaps.Add(size)
	...
	stats := [][]string{
		...
		{"Key-Value store", "Taerim snapshots", taerimSnaps.Size(), taerimSnaps.Count()},
