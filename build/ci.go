...
import (
	...
	"github.com/Freemeta-net/FMC/crypto/signify"
	"github.com/Freemeta-net/FMC/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/Freemeta-net/FMC/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/Freemeta-net/FMC/mobile")
